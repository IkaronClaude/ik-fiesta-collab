...
if "%2"=="" (
    ...
    echo Available: server, update, restart-game, start, stop, logs, tail, rebuild-game, rebuild-sql, wipe-sql, reimport, set, get, clear, list, get-connection-string, set-sql-password, api, webapp, ci, secret
    exit /b 1
)
