...
if "%2"=="" (
    ...
    echo Available: server, update, restart-game, start, stop, logs, rebuild-game, rebuild-sql, wipe-sql, reimport, set, get, list, get-connection-string, set-sql-password, api
    exit /b 1
)
