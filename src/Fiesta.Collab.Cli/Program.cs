...
var initProjectArg = new Argument<DirectoryInfo>("project", "Path to new fiesta project directory to create");
...
initCommand.SetHandler((DirectoryInfo project, string mimirCmd) =>
{
    ...
    return projectService.SaveProjectAsync(project.FullName, manifest).ContinueWith(_ =>
    {
        ...
        WriteIfMissing(Path.Combine(project.FullName, ".gitignore"),
            ...
            "deployed/\r\n" +
            "\r\n" +
            "# Pack state (regenerated by: mimir import)\r\n" +
            ".mimir-pack-manifest*.json\r\n" +
            "\r\n" +
            "# Deployment secrets — never commit, set with: mimir deploy secret set KEY VALUE\r\n" +
            ".mimir-deploy.secrets\r\n" +
            "\r\n" +
            "# TLS certificates\r\n" +
            "certs/\r\n" +
            "\r\n" +
            "# Docker deploy artefacts (server binaries, publish output)\r\n" +
            "deploy/server-files/\r\n" +
            "deploy/api-publish/\r\n" +
            "deploy/webapp-publish/\r\n" +
            "\r\n" +
            "# OS\r\n" +
            ".DS_Store\r\n" +
            "Thumbs.db\r\n");
        ...
        WriteIfMissing(Path.Combine(project.FullName, "deploy", "reimport.bat"),
            ...
            ":: NOTE: fiesta.template.json is preserved — don't regenerate it unless you mean to.\r\n" +
            "cd /d \"%~dp0..\"\r\n" +
